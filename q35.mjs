...
// these animals have in common. You could print a sentence such as Any of these animals would make a great pet!

let animals = ["dogs","cat","rabbit", "parrot"];

animals.map((pet)=>{
    console.log(pet);
})
animals.map((pet)=>{
    console.log(`A ${pet} is a great pet`);
})

console.log(`rabbit and parrot soft skin like animals`);